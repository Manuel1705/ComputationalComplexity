...
Say if there exists a reduction form the following problems:
\begin{itemize}
...
\subsection{Exercises}
\subsubsection{exercise 1}
Say if there is a reduction between the following problems:
\begin{itemize}
...
\end{itemize}
\subsubsection{exercise 2}
Assume that $\NP\not=\coNP$. Say if there exist a reduction between the following problems:
\begin{itemize}
  \item \textsc{SAT} to \textsc{VALIDITY}\\
